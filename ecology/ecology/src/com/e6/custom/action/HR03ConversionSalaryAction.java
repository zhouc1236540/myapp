...
public class HR03ConversionSalaryAction extends AbstractAction{
	...
	private void setData(JSONObject jsonObject) {
		...
		//增加一个测试数据 电话津贴默认为1000
		jsonObject.put("PerField81", getMainStringValue("dhjt","1000"));
		//部门名称
		...
		//岗位
		jsonObject.put("QtName", getGwmc(getMainIntegerValue("dzhzw"),jsonObject));
